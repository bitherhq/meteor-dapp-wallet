...
var addLogWatching = function(newDocument){
    ...
    var blockToCheckBack = (newDocument.checkpointBlock || 0) - bitherConfig.rollBackBy;
    ...
    filter.get(function(error, logs) {
        if(!error) {
            ...
            CustomContracts.update({_id: newDocument._id}, {$set: {
                checkpointBlock: (currentBlock || EthBlocks.latest.number) - bitherConfig.rollBackBy
            }});
        }
    });
...
Template['views_account'].helpers({
    ...
    */
    'showDailyLimit': function(){
        return (this.dailyLimit && this.dailyLimit !== bitherConfig.dailyLimitDefault);
    },
    /**
