        ...
        if(!tx.confirmed && tx.transactionHash) {
            ...
            var updateTransactions = function(e, blockHash){
                ...
                if(!e) {
                    ...
                    if(confirmations < bitherConfig.requiredConfirmations && confirmations >= 0) {
                    ...
                    if(confirmations > bitherumConfig.requiredConfirmations || confCount > bitherConfig.requiredConfirmations*2) {
